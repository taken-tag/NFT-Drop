...
const disconnect = useDisconnect();
    ...
    <h1 className="text-4xl font-bold text-white">PapaFam Apes</h1>
     <h2 className="text-xl text-gray-300">A Collection of apes who live & breathe react</h2>
     </div>
        </div>
    </div>
    ...
    <div className="flex flex-1 flex-col p-12 lg:col-span-6">
        ...
        <div className="mt-10 flex flex-1 flex-col items-center space-y-6 text-center lg:space-y-0 lg:justify-center">
            ...
            <h1 className="text-3xl font-bold lg:text-5xl lg:font-extrabold">The PapaFam Apes Coding Club | NFT Drop</h1>

            <p className="pt-2 text-xl text-green-500">13 / 21 Nft's Claimed</p>
        </div> 
        {/* mint button */}
        <button className="h-16 bg-red-600 w-full text-white rounded-full font-bold">
Mint NFT {"0.01 ETH"}
        </button>
    </div>
    </div>
